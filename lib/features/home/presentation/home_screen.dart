  ...
  Widget _buildActionCardsGrid(
    ...
    final actionCards = [
      _ActionCardData(
        ...
        route: '/generate-cv',
        isPremiumOnly: false, // Free for all
      ),
      _ActionCardData(
        ...
        route: '/optimize-cv',
        isPremiumOnly: true, // 🔒 Premium only
      ),
      _ActionCardData(
        title: l10n.tailorCV,
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                                'Credit purchase coming soon! Buy 25 credits for \$5 after Stripe setup.'),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
