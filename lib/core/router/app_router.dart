...
final goRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) async {
      ...
      // If user came from password reset email with error, show reset screen
      // (type=recovery case is already handled by isPasswordRecovery check at top)
      if ((isPasswordRecovery || hasAuthError) &&
          state.uri.path != '/reset-password') {
